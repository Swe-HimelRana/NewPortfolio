...
function TextRotator() {
  ...
  >
    <div className="font-poppins text-base dark:text-white sm:text-2xl [text-wrap:balance] text-gray-700">
    I am a Software Developer &
      ...
      >
        ...
        >
          <li className="text-[#2f7df4]">Ethical Hacker</li>
          <li className="text-[#2f7df4]">Linux Administrator</li>
          <li className="text-[#2f7df4]">DevOps Engineer</li>
