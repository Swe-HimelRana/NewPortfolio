...
const Navbar = () => {
  ...
  return (
    ...
    <div className={`flex  gap-3 items-center justify-center fixed  right-0 top-5  md:left-0 px-0 sm:px-5 m-auto w-full sm:w-fit bg-transparent z-[+9999999] ${scrolling ? "hidden":"block"}`}>
    <div className="md:flex items-center md:ml-[-80px]">
